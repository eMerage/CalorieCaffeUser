package emarge.project.caloriecaffe.network.firebase
...
import emarge.project.caloriecaffe.ui.activity.splash.Splash

class CalorieCaffeFirebaseMessagingService : FirebaseMessagingService() {
